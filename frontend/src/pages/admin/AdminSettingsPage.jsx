...
const FIELD_META = {
  ...
  'shipping.dtdc.api_key':           { label: 'DTDC API key', type: 'password',
    placeholder: 'api-key from DTDC/Shipsy (order upload, label, cancel)' },
  'shipping.dtdc.customer_code':     { label: 'DTDC customer code', type: 'text',
    placeholder: 'Customer code from DTDC onboarding' },
  'shipping.dtdc.tracking_username': { label: 'DTDC tracking username', type: 'text',
    placeholder: 'Username for the DTDC tracking API' },
  'shipping.dtdc.tracking_password': { label: 'DTDC tracking password', type: 'password',
    placeholder: 'Password for the DTDC tracking API' },
  'shipping.dtdc.service_type_id':   { label: 'DTDC service type', type: 'text',
    placeholder: 'B2C PRIORITY' },
  'shipping.dtdc.load_type':         { label: 'DTDC load type', type: 'text',
    placeholder: 'NON-DOCUMENT' },
  'shipping.dtdc.commodity_id':      { label: 'DTDC commodity id', type: 'text',
    placeholder: '99' },
  'shipping.dtdc.label_code':        { label: 'DTDC label code', type: 'text',
    placeholder: 'SHIP_LABEL_4X6' },
  ...
  'shipping.warehouse.city':        { label: 'Pickup warehouse city', type: 'text',
    placeholder: 'Bengaluru' },
  'shipping.warehouse.state':       { label: 'Pickup warehouse state', type: 'text',
    placeholder: 'Karnataka' },
  'shipping.warehouse.phone':       { label: 'Pickup warehouse phone', type: 'text',
